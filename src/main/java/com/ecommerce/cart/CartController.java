...
public class CartController {
    ...
    public ResponseEntity<CartResponseDto> addProductToCart(@PathVariable UUID customerId, @RequestBody CartItemRequestDto request) {
    ...
    public ResponseEntity<CartResponseDto> updateProductQuantity(@PathVariable UUID customerId, @PathVariable UUID productId, @RequestBody UpdateCartItemRequestDto request) {
